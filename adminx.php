...
if (!str_starts_with($dir, "/")) $dir = "/$dir";
$dirs = explode("/", $dir);
$dirname = "根目录";
...
<head>
    ...
    <!-- <link href="https://cdn.jsdelivr.net/gh/1689295608/AdminX/css/index.css" rel="stylesheet"> -->
    <link href="https://1689295608.github.io/AdminX/css/index.css" rel="stylesheet">
...
<body>
    ...
    <div class="adminx-index">
        ...
        <div class="admin-view">
            ...
            <div class="editor <?php echo !isset($data) ? "hidden" : ""; ?>">
